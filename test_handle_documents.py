...
class Test_read_pdf(unittest.TestCase):
    ...
    def test_analyse_content_max_found_items(self):
        ...
        self.assertTrue(1000 <= int((read_pdf.analyse_content(self.sample_text, self.lod_CAT, self.lod_CWOID, self.lod_CID, self.lod_DOC, self.lod_N))[1][3]) <= 999999)        
    ...
    def test_analyse_content_no_customer_id(self):
        ...
        self.assertTrue(1000 <= int((read_pdf.analyse_content(self.sample_text, self.lod_CAT, self.lod_CWOID, self.lod_e, self.lod_DOC, self.lod_N))[1][3]) <= 999999)        
    ...
    def test_analyse_content_no_cwoid(self):
        ...
        self.assertTrue(1000 <= int((read_pdf.analyse_content(self.sample_text, self.lod_CAT, self.lod_e, self.lod_CID, self.lod_DOC, self.lod_N))[1][3]) <= 999999)        
    ...
    def test_analyse_content_no_cat(self):
        ...
        self.assertTrue(1000 <= int((read_pdf.analyse_content(self.sample_text, self.lod_e, self.lod_CWOID, self.lod_CID, self.lod_DOC, self.lod_N))[1][3]) <= 999999)        
    ...
    def test_analyse_content_no_name(self):
        ...
        self.assertTrue(1000 <= int((read_pdf.analyse_content(self.sample_text, self.lod_CAT, self.lod_CWOID, self.lod_CID, self.lod_DOC, self.lod_e))[1][3]) <= 999999)        
...
class Test_analyse(unittest.TestCase):
    def setUp(self):
        ...
        self.unique = datetime.strftime(datetime.now(), "%m%d%H")
